...
- **Python 3.x:** Ensure that you have the latest python installed.
  (<a  href="[https://www.python.org/ftp/python/3.7.4/python-3.7.4.exe](https://www.python.org/downloads/)">Download the Latest Python</a>)
- **Pip Modules:**
  - colorama==0.4.6
  - numpy==1.26.4
